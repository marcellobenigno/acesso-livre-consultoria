...
$(document).ready(function () {
    ...
    $('.fullwidth-slider').bxSlider({
        ...
        onSlideBefore: function ($slideElement) {
            ($slideElement).find('.slide-caption').fadeOut().animate({top: '100px'}, {
                queue: false,
                easing: 'easeOutQuad',
                duration: 550
            });
        ...
        onSlideAfter: function ($slideElement) {
            ($slideElement).find('.slide-caption').fadeIn().animate({top: '0'}, {
                queue: false,
                easing: 'easeOutQuad',
                duration: 450
            });
...
//Google Map
    var latlng = new google.maps.LatLng(-7.1104607, -34.8482352);
    var settings = {
        zoom: 16,
        center: new google.maps.LatLng(-7.1104607, -34.8482352), mapTypeId: google.maps.MapTypeId.ROADMAP,
    ...
    var contentString = '<div id="content">' +
        '<div id="siteNotice">' +
        '</div>' +
        '<h3 id="firstHeading" class="firstHeading">ACESSO LIVRE</h3>' +
        '<div id="bodyContent">' +
    ...
    var companyPos = new google.maps.LatLng(-7.1104607, -34.8482352);
